...
//     // public static async Task Remove(GameStatus gameStatus, BlobService blobService)
//     // {
//     //     List<Nation> nations = await GameSystem.GatherNationsAsync(gameStatus, blobService);
