...
public partial class District : DistrictGeography
{
    public int Population { get; set; }
    public int DeltaPopulation { get; set; }
    ...
    public static District Create(DistrictParm geog, List<DistrictParm>? seas, EconParms econParms, InitParms initParms)
    {
