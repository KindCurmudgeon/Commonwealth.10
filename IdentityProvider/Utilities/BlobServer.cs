...
public class BlobService
{
    ...
    {
        if (descriptor.Obj is null) throw new Exception("Blob object is null");
        ...
        {
            throw new Exception("Error occurred while saving blob", ex);
        }
    }
    ...
    public async Task<T> RetrieveAsync<T>(string pathName) where T : IBlobObject
    {
        ...
        {
            throw new Exception("Error occurred while retrieving blob", ex);
        }
        void ValidateFileContents(IBlobObject? result)
        {
            if (result is null) throw new Exception("Retrieved blob is null");
            result.Validate();
        }
    }
    ...
    public async Task<bool> IsExisting(string blobPath)
    {
        ...
        {
            string x = ex.Message;
            throw new Exception("Error occurred while checking blob existence", ex);
        }
    }
    ...
    public async Task RemoveWithPrefix(string parentFolder, string? childFolder, string? prefix)
    {
        ...
        {
            throw new Exception("Error occurred while removing blobs with prefix", ex);
        }
    }
    public async Task<List<string>> GetFileNamesWithPrefix(string prefix)
    {
        ...
        catch (Exception ex) { throw new Exception("Error occurred while retrieving file names with prefix", ex); }
    }
    public async Task<string?> GetJsonStringAsync(string pathName)
    {
        ...
        {
            throw new Exception("Error occurred while retrieving JSON string", ex);
        }
    }
