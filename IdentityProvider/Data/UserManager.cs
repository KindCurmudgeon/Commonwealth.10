...
public class UserManager
{
     ...
     public async Task<UserProfile> GetValidatedProfile(string accessName, string password)
     {
          UserProfile? profile = await GetProfileByUserName(accessName);
     ...
     {
          return UserIndexes.Exists(u => u.UserName == userName);
     }
...
public class IndexFile : IBlobObject
{
     ...
     public static string BlobPath() { return BlobService.CreateBlobPath(Folders.IDP, null, FullFileName()); }
